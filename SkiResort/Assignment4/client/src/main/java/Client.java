...
public class Client {
  ...
  public static void main(String[] args) throws InterruptedException, IOException, ApiException {
    String EC2_SERVER = "http://54.185.248.96:8080/server/skiers/";
    String BALANCER_ADDRESS = "http://bbbbbbbb-1501414578.us-west-2.elb.amazonaws.com:8080/server/skiers";
